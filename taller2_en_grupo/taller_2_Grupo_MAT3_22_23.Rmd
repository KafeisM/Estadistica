...
# Contar cuántas observaciones hay para cada valor de la variable "lunch"
frecuencias <- table(datos$lunch)
...
# Especificar que se trata de un gráfico de barras
grafico <- grafico + geom_bar(aes(x = factor(1)))

# Especificar las variables a utilizar en el gráfico
grafico <- grafico + aes(x = lunch, y = frecuencias)
