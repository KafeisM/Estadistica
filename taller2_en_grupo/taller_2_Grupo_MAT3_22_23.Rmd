...
El gráfico muestra que, dependiendo del grado de estudio de los padres, que precio pagan en la comida.
...
El gráfico compara las notas en cada área (matemáticas, lectura y escritura), dependiendo de si se ha hecho o no el curso preparatorio.
...
En el gráfico se compara las notas de las distintas areas dependiendo de el género del estudiante.
...
a)
Queremos contrasrar la siguiente hipótesis:
...
El intervalo de confianza para el parámetro poblacional del contraste. Es equivalente afirmar que el estadístico de contraste pertenece a la región de aceptación que afirmar que el parámetro del contraste pertenece al intervalo de confianza del contraste.
No podemos afirmar nada, ya que no tenemos el parámetro poblacional
