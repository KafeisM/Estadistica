...
quantile(fifa23_eur$ValueEUR,probs)
valor4=ordered(cut(fifa23_eur$ValueEUR,breaks=c(0,quantile(fifa23_eur$ValueEUR,probs),Inf)))
```
...
```{r}
plot(density(fifa23_eur$Overall),col="red")
