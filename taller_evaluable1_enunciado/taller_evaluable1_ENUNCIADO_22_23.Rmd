...
#Value_Level <- factor(valor4,levels=c("Cuartil_1", "Cuartil_2", "Cuartil_3" , "Cuartil_4"))
Value_Level <- factor(valor4,labels=c("Cuartil_1", "Cuartil_2", "Cuartil_3" , "Cuartil_4"))
table(Value_Level)

#breaks = c(0,quantile(fifa23_eur$ValueEUR,probs = c(0.25,0.5,0.75)),Inf)
#value4 = ordered(cut(fifa23_eur$ValueEUR, breaks = breaks))
#str(value4)
...
```{r}
#table(fifa23_eur$NationalPosition,foot)
```
