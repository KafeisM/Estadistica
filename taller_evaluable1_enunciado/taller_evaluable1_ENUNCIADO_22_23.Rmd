...
```
```{r fig.align='right',echo=FALSE,out.width="70%"}
...
Crea un data frame `fifa23_eur` que contenga a TODOS  los jugadores de los clubs encontrados en el ejercicio anterior.
